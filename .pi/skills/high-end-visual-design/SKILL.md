...
|---|---|
| "Premium design is just more animations" | Premium is restraint. Every element must earn its place. |
| "Luxury means more features" | Luxury means fewer, better things. Edit ruthlessly. |
| "Stock AI-generated layouts are fine" | Premium design requires intentional composition, not generated defaults. |
| "I'll add polish after launch" | Polish added post-launch is polish never added. Ship it finished. |

## Red Flags

- Generic AI gradient backgrounds
- No custom font implementation (stuck on system fonts)
- Animations added for decoration rather than purpose
- Spacing that doesn't follow a consistent scale
- Luxury-looking elements without luxury-level attention to edge cases
