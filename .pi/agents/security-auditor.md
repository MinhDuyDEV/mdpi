...
description: Security engineer focused on vulnerability detection, threat modeling, and secure coding practices. Use when conducting a security-focused vulnerability and threat-model review, threat analysis, or hardening pass.
...
- **Invoke via slash command** as part of a parallel fan-out alongside `code-reviewer` and `test-engineer`, or any audit command your coding agent provides.
